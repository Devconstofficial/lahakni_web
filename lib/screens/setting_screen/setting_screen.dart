            ...
            Obx(
              () => DropdownButtonFormField<String>(
                ...
                decoration: InputDecoration(
                  ...
                  labelStyle: AppStyles.regularGilroyTextStyle().copyWith(
                    fontSize: 14.sp,
                  ),
                          ...
                          Row(
                            children: [
                              ...
                              customContainer(kNotiIcon, () {
                                notificationController.showNotification.value =
                                    true;
                              }),
                              SizedBox(width: 9.w),
                        ...
                        Padding(
                          ...
                          child: SliderTheme(
                            data: SliderTheme.of(context).copyWith(
                              ...
                              inactiveTrackColor: kBlackTextColor1.withOpacity(
                                0.2,
                              ),
                    ...
                    final filteredVehicles =
                        selectedType.isEmpty
                            ...
                            : controller.singleVehicleData
                                .where(
                                  (vehicle) => vehicle['name'] == selectedType,
                                )
                                .toList();
